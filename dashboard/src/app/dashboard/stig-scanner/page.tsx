    ...
    <div className="min-h-screen bg-gray-950">
      ...
      <div className="p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
          {MOCK_STIGS.map(stig => (
            <div key={stig.name} className="bg-gray-900 border border-gray-800 rounded-xl p-5">
        ...
        <div className="flex gap-3 mb-4">
          <div className="flex-1 relative">
            ...
            <input
              ...
              className="w-full bg-gray-900 border border-gray-800 rounded-lg pl-10 pr-4 py-2.5 text-sm text-white placeholder-gray-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
            />
          </div>
          ...
          <div className="divide-y divide-gray-800/50">
            {filtered.map(finding => (
              <div
                ...
                className={`px-6 py-4 hover:bg-gray-800/30 transition cursor-pointer ${
                  selectedFinding?.id === finding.id ? 'bg-gray-800/50 border-l-2 border-blue-500' : ''
                }`}
              >
          ...
          <div className="relative w-full max-w-2xl bg-gray-900 border-l border-gray-800 overflow-y-auto">
            ...
            <div className="p-6 space-y-6">
              ...
              <div>
                ...
                <pre className="text-xs font-mono text-green-400 bg-black/50 border border-gray-800 rounded-lg p-4 whitespace-pre-wrap">
              ...
              <div>
                ...
                <pre className="text-xs font-mono text-blue-400 bg-black/50 border border-gray-800 rounded-lg p-4 whitespace-pre-wrap">
              ...
              {selectedFinding.mitre_technique && (
                <div>
                  ...
                  <div className="text-xs bg-gray-800 text-gray-300 px-3 py-2 rounded font-mono">
                    {selectedFinding.mitre_technique}
                  </div>
                </div>
              )}
              ...
              <div>
                ...
                <div className="text-xs bg-gray-800 text-gray-300 px-3 py-2 rounded">
              ...
              <div className="flex gap-2 pt-2">
                ...
                <button className="flex-1 text-xs bg-gray-800 text-gray-300 py-2.5 rounded-lg font-semibold hover:bg-gray-700 transition border border-gray-700">
                  Create Ticket
                </button>
                <button className="flex-1 text-xs bg-gray-800 text-gray-300 py-2.5 rounded-lg font-semibold hover:bg-gray-700 transition border border-gray-700">
                  Export Finding
